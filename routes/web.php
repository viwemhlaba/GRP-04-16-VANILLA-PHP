...
Route::middleware(['auth', 'role:customer'])->group(function () {
    ...
    Route::get('/customer/prescriptions', [PrescriptionController::class, 'index'])->name('customer.prescriptions.index');
...
Route::middleware(['auth', 'role:manager'])->prefix('manager')->name('manager.')->group(function () {
    ...
    // Reports - open Stock Report directly on /reports
...
// Signed action links for suppliers (no auth middleware, protected by signature)
Route::get('/orders/{order}/approve', [OrderActionController::class, 'approve'])->name('orders.approve');
Route::get('/orders/{order}/decline', [OrderActionController::class, 'decline'])->name('orders.decline');
