...
class MedicationController extends Controller
{
    ...
    // Redirect to medications index with success message (Inertia-friendly redirect)
    return redirect()->route('manager.medications.index')->with('success', 'Medication updated successfully!');
    }
    ...
    public function destroy($id)
    {
        $medication = Medication::findOrFail($id);
        $medication->delete();
    // Redirect back with success message to satisfy Inertia expectations
    return redirect()->route('manager.medications.index')->with('success', 'Medication deleted successfully!');
    }
