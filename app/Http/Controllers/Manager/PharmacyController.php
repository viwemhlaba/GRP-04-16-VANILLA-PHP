...
class PharmacyController extends Controller
{
    ...
    public function create()
    {
        ...
        // Check if manager already manages a pharmacy
        if ($manager->managedPharmacies()->exists()) {
            return redirect()->route('manager.pharmacies.index')
                ->with('error', 'You can only manage one pharmacy at a time. Please edit your existing pharmacy instead.');
        }
    ...
    return Inertia::render('Manager/Pharmacies/Edit', [
            'pharmacy' => $pharmacy,
            'pharmacists' => $pharmacists,
        ]);
    }
