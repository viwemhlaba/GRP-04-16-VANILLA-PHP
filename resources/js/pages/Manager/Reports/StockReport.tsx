...
export default function StockReport({ recentReports }: StockReportProps) {
    type FormData = {
        group_by: 'dosage_form' | 'schedule' | 'supplier';
        stock_filter: 'all' | 'low_stock' | 'out_of_stock';
        include_zero_stock: boolean;
        sort_by: 'name' | 'quantity_on_hand' | 'reorder_level';
            ...
            if (!response.ok) {
                ...
                if (response.status === 404) {
                    ...
                    toast.error('Not authorized', {
                        description: 'Please make sure you are logged in as a manager.',
                        duration: 5000,
                    });
                } else {
                    // Other errors
    ...
    return (
        <AppLayout
            breadcrumbs={[
                { title: 'Reports', href: '/manager/reports' },
                { title: 'Stock', href: '/manager/reports/stock' },
            ]}
        >
                    ...
                    <div className="lg:col-span-1">
                        <Card className="rounded-none">
                            <CardHeader>
                                ...
                                <CardDescription>Generate detailed medication stock reports for inventory management and stock take.</CardDescription>
                            </CardHeader>
                            <CardContent className="space-y-4">
                                <div className="space-y-2">
                                    ...
                                    <Select
                                        ...
                                        onValueChange={(value) => handleInputChange('group_by', value as FormData['group_by'])}
                                    >
                                ...
                                <div className="space-y-2">
                                    ...
                                    <Select
                                        value={formData.stock_filter}
                                        onValueChange={(value) => handleInputChange('stock_filter', value as FormData['stock_filter'])}
                                    >
                                        <SelectTrigger className="bg-transparent">
                                ...
                                <div className="space-y-2">
                                    ...
                                    <Select
                                        ...
                                        onValueChange={(value) => handleInputChange('sort_by', value as FormData['sort_by'])}
                                    >
                                        <SelectTrigger className="bg-transparent">
                                ...
                                <div className="space-y-2">
                                    ...
                                    <Select
                                        ...
                                        onValueChange={(value) => handleInputChange('sort_direction', value as FormData['sort_direction'])}
                                    >
                                        <SelectTrigger className="bg-transparent">
                                ...
                                <div className="flex items-center space-x-2">
                                    <Checkbox
                                        ...
                                        onCheckedChange={(checked) => handleInputChange('include_zero_stock', Boolean(checked))}
                                    />
                    ...
                    <div className="lg:col-span-2">
                        <Card className="rounded-none">
                            <CardHeader>
                                ...
                                <CardDescription>Your most recent generated stock reports.</CardDescription>
                            </CardHeader>
                            <CardContent>
