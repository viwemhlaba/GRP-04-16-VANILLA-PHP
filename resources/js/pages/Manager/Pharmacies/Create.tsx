...
export default function PharmacyCreate({ pharmacists, errors }: PharmacyCreateProps) {
    ...
    const breadcrumbs: BreadcrumbItem[] = [
        { title: 'Pharmacies', href: route('manager.pharmacies.index') },
        { title: 'Add Pharmacy', href: route('manager.pharmacies.create') },
    ];
                            ...
                            <div className="space-y-4">
                                ...
                                <div>
                                    ...
                                    >
                                        ...
                                        <SelectContent>
                                            {pharmacists
                                                .filter((pharmacist) => pharmacist.id && pharmacist.id.toString().trim() !== '')
                                                .map((pharmacist) => (
