    ...
    return (
        <AppLayout
            breadcrumbs={[
                ...
                { title: 'Edit', href: `/manager/dosage-forms/${dosageForm.id}/edit` },
            ]}
        >
            ...
            <div className="flex h-full flex-1 flex-col gap-6 p-6">
                <div className="w-full md:w-3/4">
                    <Card className="rounded-none">
                        <CardHeader>
                            <CardTitle>Edit Dosage Form</CardTitle>
                            <CardDescription>Update the name of this dosage form.</CardDescription>
                        </CardHeader>
                        <CardContent>
