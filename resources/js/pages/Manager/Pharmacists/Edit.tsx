...
export default function PharmacistEdit({ pharmacist, errors }: PharmacistEditProps) {
    ...
    return (
        <AppLayout
            breadcrumbs={[
                { title: 'Pharmacists', href: '/manager/pharmacists' },
                { title: 'Edit', href: `/manager/pharmacists/${pharmacist.id}/edit` },
            ]}
        >
            ...
            <div className="flex h-full flex-1 flex-col gap-6 p-6">
                <div className="w-full md:w-3/4">
                    <Card className="rounded-none">
                        <CardHeader>
                            <CardTitle>Edit Pharmacist</CardTitle>
                            <CardDescription>Update the details for this pharmacist user.</CardDescription>
                        </CardHeader>
                        <CardContent>
