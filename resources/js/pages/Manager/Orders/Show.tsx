    ...
    return (
        <AppLayout
            breadcrumbs={[
                ...
                { title: `Order ${order.order_number}`, href: `/manager/orders/${order.id}` },
            ]}
        >
                        ...
                        <Card className="rounded-none">
                            <CardHeader>
                                <CardTitle className="flex items-center">
                                    <User className="mr-2 h-5 w-5" /> Supplier
                                </CardTitle>
                            </CardHeader>
                            ...
                            <CardContent className="space-y-3">
                                ...
                                <div>
                                    ...
                                    <p className="flex items-center text-sm">
                                        <Calendar className="mr-1 h-4 w-4" /> {new Date(order.created_at).toLocaleDateString()}
                                    </p>
                                </div>
                                {order.received_at && (
                                    <div>
                                        ...
                                        <p className="flex items-center text-sm">
                                            <Calendar className="mr-1 h-4 w-4" /> {new Date(order.received_at).toLocaleDateString()}
                                        </p>
                                    </div>
                                )}
                            </CardContent>
