...
export default function Repeats() {
    ...
    const breadcrumbs = [
        ...
        { title: 'Requested Repeats', href: route('pharmacist.repeats') }, // Use web route, not API route
    ];
        ...
        <AppLayout breadcrumbs={breadcrumbs}>
            ...
            <div className="flex h-full flex-1 flex-col gap-6 p-6">
                <div className="space-y-1">
                    <h1 className="text-2xl font-semibold tracking-tight">Requested Repeats</h1>
                    <p className="text-muted-foreground text-sm">Review, approve, or reject repeat medication requests from customers.</p>
                </div>
                ...
                <Card className="rounded-none">
                    <CardContent className="pt-6">
                        <div className="text-muted-foreground text-sm">
                            <strong>Guidelines:</strong> Reject if too soon after last dispense, for medical concerns, or incomplete documentation.
