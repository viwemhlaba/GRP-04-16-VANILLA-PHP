...
export default function CreateCustomer() {
    ...
    const breadcrumbs = [
        ...
        { title: 'Create Customer', href: route('pharmacist.customers.create') },
    ];
        ...
        <AppLayout breadcrumbs={breadcrumbs}>
            ...
            <div className="flex h-full flex-1 flex-col gap-6 p-6">
                <div className="space-y-1">
                    <h1 className="text-2xl font-semibold tracking-tight">Create Customer Account</h1>
                    <p className="text-muted-foreground text-sm">Create a new customer account for walk-in patients.</p>
                </div>
