...
export default function PrescriptionIndex({
    ...
    const breadcrumbs = [{ title: 'Prescriptions', href: route('pharmacist.prescriptions.index') }];
            ...
            <div className="flex h-full flex-1 flex-col gap-6 p-6">
                ...
                <div className="flex flex-col gap-4 md:flex-row md:items-center md:justify-between">
                    <div className="space-y-1">
                        ...
                        <p className="text-muted-foreground text-sm">View uploaded and manually created prescriptions.</p>
                    </div>
                    <div className="flex flex-wrap gap-2">
                        <Button variant="outline" asChild>
                            <Link href={route('pharmacist.customers.create')}>Create Customer</Link>
                        </Button>
                        <Button asChild>
                ...
                <Card className="rounded-none">
                    <CardHeader className="pb-2">
                        <CardTitle className="text-lg font-medium">Uploaded Prescriptions</CardTitle>
                    </CardHeader>
                    <CardContent>
                ...
                <Card className="rounded-none">
                    <CardHeader className="pb-2">
                        <CardTitle className="text-lg font-medium">Manual Prescriptions</CardTitle>
                    </CardHeader>
                    <CardContent>
