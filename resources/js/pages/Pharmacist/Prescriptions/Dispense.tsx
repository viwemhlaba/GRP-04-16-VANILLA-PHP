...
export default function DispensePrescription({ prescriptions }: { prescriptions: Prescription[] }) {
    ...
    const canDispense = (prescription: Prescription) => prescription.status === 'approved' && prescription.repeats_used < prescription.repeats_total;
        ...
        <AppLayout breadcrumbs={breadcrumbs}>
            ...
            <div className="flex h-full flex-1 flex-col gap-6 p-6">
                ...
                <div className="space-y-1">
                    <h1 className="text-2xl font-semibold tracking-tight">Dispense Prescriptions</h1>
                    <p className="text-muted-foreground text-sm">Review and dispense approved prescriptions to patients.</p>
                </div>
                    ...
                    <CardContent>
                        ...
                        {dispensablePrescriptions.length === 0 ? (
                            <div className="py-8 text-center">
                                ...
                                <p className="text-muted-foreground mt-2 text-sm">Prescriptions must be approved and have remaining repeats.</p>
                            </div>
                        ) : (
