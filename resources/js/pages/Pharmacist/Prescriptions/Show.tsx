...
import { Calendar, Download, FileText, Mail, MapPin, Package, Phone, Pill, User } from 'lucide-react';
...
export default function Show({ prescription, dispensed_history, totals, current_pharmacist }: Props) {
    ...
    const breadcrumbs = [
        ...
        { title: `Prescription #${prescription.id}`, href: route('pharmacist.prescriptions.show', prescription.id) },
    ];
